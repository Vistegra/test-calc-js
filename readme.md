...
### Будем смотреть:
- Верность расчетов в первую очередь.
...
- Стиль/Парадигма программирования (процедурный, функциональный, ООП(желательно))
...
### Будет плюсом:
- Использование фрэймворка (react/vue).
- Тесты
- Использование webpack/vite.
- Паттерн проектирование (MVVM/MVC/...).
- Любая анимация.
<hr>
...
- d1 - Любые прочие доработки обязательно будут учтены. Только если основная часть задачи выполнена.
...
#### Ориентировочное время выполнения - 5 часов (с "чистого листа")
